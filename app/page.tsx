    ...
    <main className="min-h-screen overflow-x-hidden bg-white text-slate-900">
      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-[1680px] flex-col gap-4 p-3 sm:p-4 lg:grid lg:grid-cols-[minmax(0,1.35fr)_420px] lg:gap-5 lg:p-5">
        <section className="flex min-h-0 flex-col gap-4 lg:gap-5">
          <div className="rounded-2xl border border-slate-200 bg-[#f7fbf9] p-3 sm:p-4">
            <div
              id="description"
          ...
          <section className="flex min-h-0 flex-1 flex-col" id="agency-staff">
            ...
            <div className="w-full max-w-[420px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_1px_0_rgba(0,0,0,0.03)]">
        ...
        <aside className="min-h-0 lg:sticky lg:top-4">
          <div className="flex h-full min-h-[420px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
            <div className="border-b border-slate-200 px-4 py-4 sm:px-5">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <p className="text-[10px] font-medium uppercase tracking-[0.28em] text-emerald-600 sm:text-sm">
                    Location
                  </p>
